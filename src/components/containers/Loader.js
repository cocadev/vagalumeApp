...
class Loader extends Component {
    ...
    render() {
        ...
        return (
            <View style={{ width: size, height: size, borderColor: '#444', borderWidth: 2, borderRadius: size / 2, justifyContent: 'center', alignItems: 'center' }}>
                { interpolatedRotateAnimation != null && <Animated.Image
